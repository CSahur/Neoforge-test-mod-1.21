package com.csahur.testmod.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks TESTBLOCKS =
    ...
    private static <T extends Block> DeferredBlock<T> registerBlock(String name, Supplier<T> block) {
        DeferredBlock<T> toReturn = TESTBLOCKS.register(name, block);
